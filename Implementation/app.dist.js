...
var Broadcast = new Application('Broadcast', function (publicSandbox) {
  return {
    ...
    broadCastMessage: function broadCastMessage(event) {
...
var Calculator = new Application('Calculator', function calculatorConstructor() {
  var _this = this;
  ...
  return {
    ...
    eval: function _eval() {
      return eval(_this.auxiliarValue + _this.currentOperation + _this.value);
    },
    template: '<div class="application"></div>' };
});
...
var Tap = new Application('Tap', function (publicSandbox) {
  return {
    ...
    drainWater: function drainWater() {
...
var WaterBox = new Application('WaterBox', function (publicSandbox) {
  return {
    ...
    collectWater: function collectWater(event) {
    ...
    drainWater: function drainWater(event) {
...
var Keyboard = new Module(function (sandbox) {
  return {
    pressButton: function pressButton(input) {
      if (isNaN(input)) {
